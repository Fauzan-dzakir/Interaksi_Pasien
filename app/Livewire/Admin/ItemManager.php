...
class ItemManager extends Component
{
    ...
    public string $sterilization_method = '';
    ...
    public function edit(int $id): void
    {
        ...
        $this->sterilization_method = $item->sterilization_method?->value ?? '';
    ...
    public function save(): void
    {
        $data = $this->validate([
            ...
            'sterilization_method' => ['nullable', Rule::enum(\App\Enums\SterilizationMethod::class)],
    ...
    {
        $this->reset(['editingId', 'code', 'name', 'category', 'material_sensitivity', 'sterilization_method', 'notes', 'is_active', 'image', 'currentImage']);
        $this->material_sensitivity = 'heat_water_resistant';
        $this->sterilization_method = '';
        $this->is_active = true;
        $this->resetErrorBag();
    }
    ...
    public function render()
    {
        ...
        return view('livewire.admin.item-manager', [
            ...
            'sterilizationOptions' => collect(\App\Enums\SterilizationMethod::cases())
