...
<?php endif; ?>
    ...
    <div class="space-y-4">
        ...
        <details <?php if($role === \App\Enums\UserRole::Admin): ?> open <?php endif; ?> class="card overflow-hidden">
        ...
        <details <?php if($role === \App\Enums\UserRole::CssdStaff): ?> open <?php endif; ?> class="card overflow-hidden">
            <summary class="cursor-pointer select-none px-5 py-4 text-sm font-semibold text-slate-900 hover:bg-slate-50">
                Untuk Petugas CSSD
            </summary>
            <div class="border-t border-slate-200 px-5 py-4 text-sm text-slate-700 space-y-4">
        ...
        <details <?php if($role === \App\Enums\UserRole::Nakes): ?> open <?php endif; ?> class="card overflow-hidden">
            <summary class="cursor-pointer select-none px-5 py-4 text-sm font-semibold text-slate-900 hover:bg-slate-50">
