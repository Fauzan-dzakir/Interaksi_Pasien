...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Baris-baris berikut berisi pesan galat bawaan yang dipakai kelas Validator.
    | Beberapa aturan punya beberapa versi seperti aturan ukuran (size). Silakan
    ...
    */
    ...
    'encoding' => ':attribute harus memakai enkoding :encoding.',
    ...
    'list' => ':attribute harus berupa senarai (list).',
    ...
    'min' => [
        ...
        'string' => ':attribute harus berjumlah minimal :min karakter.',
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Di sini Anda bisa menentukan pesan validasi khusus untuk atribut dengan
    | konvensi "atribut.aturan" sebagai nama barisnya, agar mudah menentukan
    | baris bahasa khusus untuk aturan tertentu pada sebuah atribut.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Baris-baris berikut dipakai untuk mengganti placeholder atribut dengan
    | sesuatu yang lebih mudah dibaca, mis. "Alamat Email" alih-alih "email".
    | Ini membantu membuat pesan galat lebih jelas dan ramah pengguna.
    |
    */
